...
u32 GameData::GetRightPlayerPoints() const
{
	return sPlayer.iRightPlayerPoints;
}

void GameData::SetRightPlayerPoints(const u32 points)
{
	sPlayer.iRightPlayerPoints = points;
}
