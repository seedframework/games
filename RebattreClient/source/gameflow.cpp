...
// GUI Elements
const u32 GameFlow::GetLeftPlayerPoints()
{
	return gGameData->GetLeftPlayerPoints();
}

void GameFlow::SetLeftPlayerPoints(u32 points)
{
	char x[100];
...
const u32 GameFlow::GetRightPlayerPoints()
{
	return gGameData->GetRightPlayerPoints();
}

void GameFlow::SetRightPlayerPoints(u32 points)
{
	char x[100];
	snprintf(x, 100, "%d", points);
