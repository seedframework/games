#ifndef _PLAYER_RIGHT_ENTITY_H
#define _PLAYER_RIGHT_ENTITY_H

#include "sprite_entity.h"
#include "../defines.h"
#include <Box2D/Box2D.h>

class PlayerRightEntity: public SpriteEntity,
					public IEventInputKeyboardListener
{
	public:
		PlayerRightEntity();
		virtual ~PlayerRightEntity();
