SOURCES += source/main.cpp \
		...
		source/states/lobby_state.cpp \
		source/data/rs_data.cpp \
		source/manager/gui_manager.cpp \
		source/net/rs_client.cpp \
		source/entity/player_entity.cpp
...
HEADERS += \
		...
		source/states/lobby_state.h \
		source/data/rs_data.h \
		source/manager/gui_manager.h \
		source/net/rs_client.h \
		source/entity/player_entity.h
